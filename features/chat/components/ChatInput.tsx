    ...
    >
      <div className="flex items-end gap-1.5 sm:gap-2">
        ...
        <button
          ...
          className="h-13 rounded-lg bg-blue-600 px-3 text-sm font-medium text-white transition hover:bg-blue-700 disabled:cursor-not-allowed disabled:bg-blue-300 sm:px-4"
        >
          Send
        </button>
      </div>
