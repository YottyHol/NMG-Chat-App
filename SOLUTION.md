...
Then I extended out into the more complex logic and the less fundamental design, retry logic, mobile considerations and then and example of how I would start the testing suite.
...
I kept a types files (one component/feature level one domain level) for managing the expected contracts and the expectation of use i.e user and assistant messages - this allows it to be extended further.
...
I'd like to improve the focus behaviour, I feel the chat history should scroll behind the chat box and that perhaps the chat should be higher up the page.
